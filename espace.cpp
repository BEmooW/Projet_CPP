...
{this->numsalle=numsalle; this->capacite=capacite; this->bloc=bloc; this->type=type;this->etat=etat;}
...
bool Espace::ajouter()
{
                      ...
                      QSqlQuery query;
                       query.prepare("INSERT INTO espace (numsalle, capacite, bloc, type, etat) "
                                     "VALUES (:numsalle, :capacite, :bloc, :type, :etat)");
                       query.bindValue(0, numsalle_string);
                       query.bindValue(1, capacite);
                       query.bindValue(2, bloc);
    ...
    QSqlQuery query;
           QString res=QString::number(numsalle);
            QString res1=QString::number(capacite);
             ...
             query.prepare("UPDATE espace SET capacite=:capacite, bloc=:bloc , type=:type , etat=:etat , where numsalle=:res ");


                   query.addBindValue(res);
                   query.addBindValue(res1);
                   query.addBindValue(bloc);
